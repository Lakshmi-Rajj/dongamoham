...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const RELATIONSHIP_START = new Date('2020-05-18T00:00:00');

  const LOVE_MESSAGES = [
    'I love you 💜', 'You are my everything ❤️', 'Together forever 💕',
    'My heart is yours 💖', 'I adore you 🥰', 'You are beautiful ✨',
    'My beloved 🌸', 'Forever yours 💫', 'You are my happiness 🦋', 'Love without words 🌹'
  ];

  const LYRICS = [
    { time: 14.7, text: "Your morning eyes, I could stare like watching stars" },
    { time: 22.2, text: "I could walk you by, and I'll tell without a thought" },
    { time: 28.4, text: "You'd be mine, would you mind if I took your hand tonight?" },
    { time: 32.6, text: "Know you're all that I want this life" },
    { time: 39.8, text: "I'll imagine we fell in love" },
    { time: 44.4, text: "I'll nap under moonlight skies with you" },
    { time: 50.6, text: "I think I'll picture us, you with the waves" },
    { time: 54.2, text: "The ocean's colors on your face" },
    { time: 58.5, text: "I'll leave my heart with your air" },
    { time: 63.0, text: "So let me fly with you" },
    { time: 67.5, text: "Will you be forever with me?" },
    { time: 94.2, text: "My love will always stay by you" },
    { time: 99.6, text: "I'll keep it safe, so don't you worry a thing" },
    { time: 106.0, text: "I'll tell you I love you more" },
    { time: 111.6, text: "It's stuck with you forever" },
    { time: 116.4, text: "So promise you won't let it go" },
    { time: 122.8, text: "I'll trust the universe will always bring me to you" },
    { time: 134.2, text: "I'll imagine we fell in love" },
    { time: 139.6, text: "I'll nap under moonlight skies with you" },
    { time: 144.4, text: "I think I'll picture us, you with the waves" },
    { time: 148.0, text: "The ocean's colors on your face" },
    { time: 152.2, text: "I'll leave my heart with your air" },
    { time: 157.0, text: "So let me fly with you" },
    { time: 161.5, text: "Will you be forever with me?" }
  ];
  ...
  function preloadAllMedia(onComplete) {
    ...
    function tick() {
      ...
      if (loaded >= total) {
        // Everything loaded — fade out smoothly
        setTimeout(() => {
    ...
    // Loading videos (waiting for canplaythrough)
