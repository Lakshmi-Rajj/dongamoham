...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const LYRICS = [
    ...
    { time: 81.0, text: "My love will always stay by you" },
    { time: 87.2, text: "I'll keep it safe, so don't you worry a thing" },
    { time: 92.4, text: "I'll tell you I love you more" },
    { time: 98.2, text: "It's stuck with you forever" },
    { time: 103.6, text: "So promise you won't let it go" },
    { time: 120.4, text: "I'll trust the universe will always bring me to you" },
    { time: 126.8, text: "I'll imagine we fell in love" },
    { time: 132.4, text: "I'll nap under moonlight skies with you" },
    { time: 138.2, text: "I think I'll picture us, you with the waves" },
    { time: 143.6, text: "The ocean's colors on your face" },
    { time: 148.4, text: "I'll leave my heart with your air" },
    { time: 158.4, text: "So let me fly with you" },
